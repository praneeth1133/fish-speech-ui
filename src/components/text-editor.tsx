...
const PROMPT_SUGGESTIONS = [
  ...
  "[WHISPERING] Let me tell you a secret that nobody else knows...",
...
export function TextEditor() {
  ...
  const anyBusy = isGenerating || isAnnotating || isIdentifying;
  ...
  return (
    <div className="flex flex-col h-full w-full lg:border-r border-border">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex flex-col">
        {/* Prompt suggestions — shown when textarea is empty, ABOVE the textarea */}
        {!text && (
          <div className="mb-3">
            <p className="text-[10px] sm:text-[11px] text-muted-foreground/50 mb-2 uppercase tracking-wider font-medium">
              Get started with
            </p>
